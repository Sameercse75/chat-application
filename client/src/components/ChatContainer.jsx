...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      {/* -------bottom area------ */}
      <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3 z-20 bg-black/40 backdrop-blur-sm">
        <div className="flex-1 flex items-center bg-white/6 px-3 rounded-full">
          <input
